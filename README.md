...
- `/konto/` – eingeladener Zugang mit Profilfeldern, Fähigkeitsportfolio, Nachweisen, Projekten, Möglichkeiten, privater Resonanz, Export und eigenen Rechten
...
Dasselbe Konto kann die fünf Signale „Ich habe“, „Ich kann“, „Ich brauche“, „Ich habe Zeit“ und „Es gibt eine Chance“ als Möglichkeiten erfassen. Jeder Eintrag beginnt als Entwurf; Ort, Zeit, Beziehungsmodus, Vergütungsrahmen, Risikohinweis und benötigte Fähigkeiten bleiben ausdrücklich sichtbar. Einzelfreigaben laufen wie Portfolioinhalte über `publication_actions`; erst zusammen mit einem öffentlich veröffentlichten Eigentümerprofil wird der Eintrag ausgeliefert. Im öffentlichen Strom unter `/leistungen/` kann ein anderes angemeldetes Mitglied genau eine private Resonanz senden. Nur die beiden Beteiligten sehen sie; die Eigentümerperson entscheidet über Annahme oder Ablehnung, die antwortende Person kann zurückziehen, und erst die Annahme öffnet einen privaten Nachrichtenraum. Es werden keine E-Mail-Adressen automatisch offengelegt und keine Aufträge oder Zuordnungen erzeugt. Die Verträge stehen in `docs/OPPORTUNITY-DATA-CONTRACT.md` und `docs/RESONANCE-DATA-CONTRACT.md`.
